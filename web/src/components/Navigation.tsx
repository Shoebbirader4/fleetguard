...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    roles: ['super_admin', 'company_owner', 'fleet_manager'],
  },
  {
    name: 'Settings',
    path: '/settings',
    ...
    <>
      ...
      <aside className="hidden lg:flex lg:flex-col lg:fixed lg:inset-y-0 lg:w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center gap-2 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900 dark:text-gray-100">FleetGuard</h1>
            <p className="text-xs text-gray-500 dark:text-gray-400">AI Fleet Management</p>
          </div>
        </div>
